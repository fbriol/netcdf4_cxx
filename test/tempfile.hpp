...
class TempFile {
 ...
 public:
  TempFile() : temp_(boost::filesystem::unique_path()) {}

  explicit TempFile(const std::string& path) : temp_(path) {}

  std::string Path() const { return temp_.native(); }

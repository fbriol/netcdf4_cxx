...
BOOST_AUTO_TEST_CASE(type_enum) {
  ...
  BOOST_CHECK(type.GetBaseType().GetPrimitive() ==
...
BOOST_AUTO_TEST_CASE(type_compound) {
  ...
  BOOST_CHECK(type.GetMemberClass(0).GetPrimitive() ==
              netcdf::type::Primitive::kChar);
  BOOST_CHECK(type.GetMemberClass(1).GetPrimitive() ==
              netcdf::type::Primitive::kShort);
  BOOST_CHECK(type.GetMemberClass(2).GetPrimitive() ==
              netcdf::type::Primitive::kInt);
  BOOST_CHECK(type.GetMemberClass(3).GetPrimitive() ==
              netcdf::type::Primitive::kFloat);
  BOOST_CHECK(type.GetMemberClass(4).GetPrimitive() ==
